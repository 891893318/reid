...
def get_parser():
    ...
    parser.add_argument('--cmpc-weight', default=0.02, type=float, help='weight of late cross-modal prototype contrastive ranking')
    parser.add_argument('--cmpc-temperature', default=0.1, type=float, help='temperature of cross-modal prototype contrastive ranking')
