...
def get_parser():
    ...
    parser.add_argument('--enable-hnp', default=0, type=int, help='enable reliable common-relation hard-negative prototype separation')
    parser.add_argument('--hnp-start-epoch', default=30, type=int, help='phase-2 epoch to start hard-negative prototype separation')
    parser.add_argument('--hnp-weight', default=0.05, type=float, help='weight of hard-negative prototype separation')
    parser.add_argument('--hnp-margin', default=0.1, type=float, help='cosine margin of hard-negative prototype separation')
    parser.add_argument('--hnp-min-separation', default=0.0, type=float, help='minimum positive-vs-hard-negative cosine gap required before HNP is applied')
