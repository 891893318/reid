...
def main(args):
    ...
    if args.mode == "train":
        ...
        if enable_phase1:
            if hasattr(dataset, 'set_train_phase'):
                dataset.set_train_phase(True)
...
def get_parser():
    ...
    parser.add_argument('--enable-train-graymix', default=0, type=int, help='mix visible ChannelExchange and GrayMix augmentations during phase2')
    parser.add_argument('--graymix-min-lambda', default=0.3, type=float, help='lower bound of the phase2 GrayMix interpolation strength')
    parser.add_argument('--graymix-lambda', default=0.8, type=float, help='upper bound of the phase2 GrayMix interpolation strength')
    parser.add_argument('--graymix-probability', default=0.5, type=float, help='probability of using GrayMix instead of ChannelExchange during phase2')
