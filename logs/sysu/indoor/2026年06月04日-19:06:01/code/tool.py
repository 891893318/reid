...
def infer_method(args: dict[str, Any]) -> str:
    if value_is_enabled(args.get("enable_rgmfd")):
        return "RG-MFD+RGSPC" if value_is_enabled(args.get("enable_rgspc")) else "RG-MFD"
    return "Base/CRE"
...
def build_short_params(args: dict[str, Any]) -> str:
    pairs = [
        ...
        ("enable_rgspc", "rgspc", "-"),
        ("rgspc_start_epoch", "rgspc_start", None),
        ("rgspc_weight", "rgspc_w", None),
        ("rgspc_decay_power", "rgspc_decay", None),
        ("rgspc_confidence_min", "rgspc_cmin", None),
        ("rgspc_temperature", "rgspc_t", None),
        ("rgspc_hard_k", "rgspc_k", None),
        ("rgspc_hard_weight", "rgspc_hw", None),
        ("enable_raecl", "raecl", "-"),
        ("raecl_min_weight", "raecl_min", None),
        ("raecl_momentum", "raecl_m", None),
        ("enable_rgrc", "rgrc", "-"),
        ("rgrc_start_epoch", "rgrc_start", None),
        ("rgrc_common_tail_ratio", "rgrc_tail", None),
        ("rgrc_common_min_weight", "rgrc_cmin", None),
        ("rgrc_specific_threshold", "rgrc_s", None),
        ("rgrc_remain_threshold", "rgrc_r", None),
    ]
