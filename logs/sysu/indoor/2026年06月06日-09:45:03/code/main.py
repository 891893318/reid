...
def get_parser():
    ...
    parser.add_argument('--enable-lrmd', default=0, type=int, help='enable reliability-guided low-rank modality denoising')
    parser.add_argument('--lrmd-start-epoch', default=40, type=int, help='phase2 epoch to replace full-space alignment with RG-LMD')
    parser.add_argument('--lrmd-rank', default=8, type=int, help='rank of the reliable modality-gap subspace')
    parser.add_argument('--lrmd-weight', default=0.02, type=float, help='weight of RG-LMD projected alignment loss')
    parser.add_argument('--lrmd-update-interval', default=5, type=int, help='epochs between RG-LMD basis updates')
