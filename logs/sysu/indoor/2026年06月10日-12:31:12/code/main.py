...
def get_parser():
    ...
    parser.add_argument('--uclae-weight', default=1.0, type=float, help='weight of uncertainty-gated collaborative expert distillation')
    parser.add_argument('--uclae-temperature', default=1.0, type=float, help='distillation temperature for uncertainty-gated CLAE')
    parser.add_argument('--uclae-conflict-temperature', default=0.25, type=float, help='decay temperature for cross-modal prediction conflict')
    parser.add_argument('--uclae-min-teacher-confidence', default=0.2, type=float, help='minimum normalized confidence of the native-modal teacher')
    parser.add_argument('--uclae-require-native-correct', default=1, type=int, help='only distill when the native-modal expert predicts its label correctly')
