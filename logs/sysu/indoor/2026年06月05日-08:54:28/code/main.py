...
def get_parser():
    ...
    parser.add_argument('--enable-ddclae', default=0, type=int, help='enable disagreement-aware dynamic CLAE distillation')
    parser.add_argument('--ddclae-start-epoch', default=40, type=int, help='phase2 epoch to start DD-CLAE')
    parser.add_argument('--ddclae-weight', default=0.02, type=float, help='weight of DD-CLAE distillation loss')
    parser.add_argument('--ddclae-temperature', default=2.0, type=float, help='temperature for DD-CLAE KL distillation')
    parser.add_argument('--ddclae-mid', default=0.35, type=float, help='preferred medium disagreement value for DD-CLAE')
    parser.add_argument('--ddclae-bandwidth', default=0.35, type=float, help='bandwidth of DD-CLAE disagreement weighting')
    parser.add_argument('--ddclae-min-weight', default=0.05, type=float, help='minimum sample weight in DD-CLAE')
