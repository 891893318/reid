...
def get_parser():
    ...
    parser.add_argument('--eot-common-threshold', default=0.08, type=float, help='minimum reliability for mutual EOT-RR common relations')
    parser.add_argument('--eot-specific-threshold', default=0.04, type=float, help='minimum reliability for one-way EOT-RR specific relations')
    parser.add_argument('--eot-remain-threshold', default=0.02, type=float, help='minimum reliability for conflicted EOT-RR remain relations')
