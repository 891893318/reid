...
def infer_method(args: dict[str, Any]) -> str:
    if value_is_enabled(args.get("enable_hcl")):
        return "RG-MFD+HCL" if value_is_enabled(args.get("enable_rgmfd")) else "HCL"
...
def build_short_params(args: dict[str, Any]) -> str:
    pairs = [
        ...
        ("enable_hcl", "hcl", "-"),
        ("hcl_weight", "hcl_w", None),
        ("hcl_topk", "hcl_k", None),
        ("hcl_min_coverage", "hcl_cov", None),
        ("hcl_full_coverage", "hcl_full", None),
        ("hcl_min_stability", "hcl_stab", None),
        ("enable_rdl", "rdl", "-"),
        ("enable_trrm", "trrm", "-"),
