...
def get_parser():
    ...
    parser.add_argument('--enable-uprt', default=0, type=int, help='replace CCL with uncertainty-guided partial relation transport')
    ...
    parser.add_argument('--uprt-specific-ce-weight', default=0.03, type=float, help='weight of CRE specific-pair soft classifier expansion')
    parser.add_argument('--uprt-remain-ce-weight', default=0.01, type=float, help='weight of CRE remain-pair soft classifier expansion')
    parser.add_argument('--uprt-specific-ce-start-epoch', default=20, type=int, help='phase2 epoch to start specific-pair expansion')
    parser.add_argument('--uprt-remain-ce-start-epoch', default=40, type=int, help='phase2 epoch to start remain-pair expansion')
    parser.add_argument('--uprt-relation-ce-warmup-epochs', default=10, type=int, help='epochs used to ramp CRE relation expansion')
    parser.add_argument('--uprt-specific-ce-strength', default=0.5, type=float, help='target blend strength for specific-pair expansion')
    parser.add_argument('--uprt-remain-ce-strength', default=0.25, type=float, help='target blend strength for remain-pair expansion')
    ...
    parser.add_argument('--uprt-hard-weight', default=0.0, type=float, help='weight of posterior top-1 hard negative contrastive loss')
    parser.add_argument('--uprt-hard-start-epoch', default=40, type=int, help='phase2 epoch to start posterior top-1 hard supervision')
    ...
    parser.add_argument('--uprt-hard-min-confidence', default=0.85, type=float, help='minimum posterior top-1 confidence for hard supervision')
