...
--uprt-specific-ce-weight 0.03 \
--uprt-remain-ce-weight 0.01 \
--uprt-specific-ce-start-epoch 20 \
--uprt-remain-ce-start-epoch 40 \
--uprt-relation-ce-warmup-epochs 10 \
--uprt-specific-ce-strength 0.50 \
--uprt-remain-ce-strength 0.25 \
