...
def get_parser():
    ...
    parser.add_argument('--enable-train-graymix', default=0, type=int, help='replace visible ChannelExchange augmentation with random GrayMix')
    parser.add_argument('--graymix-lambda', default=0.5, type=float, help='upper bound of the random GrayMix interpolation strength')
