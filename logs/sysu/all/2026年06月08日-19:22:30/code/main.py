...
def get_parser():
    ...
    parser.add_argument('--rank-hard-weight', default=0.05, type=float, help='weight of cross-modal hard ranking loss')
    parser.add_argument('--rank-hard-margin', default=0.1, type=float, help='margin for cross-modal hard negative ranking')
    parser.add_argument('--rank-hard-topk', default=5, type=int, help='number of hardest cross-modal negatives')
    parser.add_argument('--rank-hard-start', default=30, type=int, help='phase2 epoch to start hard ranking loss')
    parser.add_argument('--rank-pos-weight', default=0.2, type=float, help='positive pull weight inside hard ranking loss')
