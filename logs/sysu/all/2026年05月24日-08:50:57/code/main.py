...
def get_parser():
    ...
    parser.add_argument('--cre-count-weight', default=1.0, type=float, help='count-priority weight in confidence-aware CRE')
    parser.add_argument('--cre-prob-weight', default=0.5, type=float, help='classification probability weight in confidence-aware CRE')
    parser.add_argument('--cre-margin-weight', default=0.5, type=float, help='top1-top2 margin weight in confidence-aware CRE')
    parser.add_argument('--cre-entropy-weight', default=0.3, type=float, help='prediction certainty weight in confidence-aware CRE')
    parser.add_argument('--cre-proto-weight', default=0.5, type=float, help='cross-modal prototype similarity weight in confidence-aware CRE')
    ...
    parser.add_argument('--cre-margin-decay-epoch', default=30, type=int, help='epochs used to relax the CRE margin filter')
    ...
    # Feature module and common-relation enhancement
    parser.add_argument('--feature-texture-weight', default=0.2, type=float, help='fusion weight for lightweight texture branch in backbone')
    parser.add_argument('--common-tri-weight', default=1.2, type=float, help='multiplier for triplet losses constructed from common relations')
    parser.add_argument('--common-cmo-weight', default=1.2, type=float, help='multiplier for CMO/prototype alignment losses from common relations')
