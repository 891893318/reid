...
def get_parser():
    ...
    parser.add_argument('--cmpc-weight', default=0.1, type=float, help='weight of bounded late cross-modal prototype ranking')
    parser.add_argument('--cmpc-margin', default=0.18, type=float, help='target positive-to-hard-negative cosine margin for CMPC')
    parser.add_argument('--cmpc-topk', default=1, type=int, help='require the matched cross-modal prototype to rank within top-k in both directions')
    parser.add_argument('--cmpc-min-positive-similarity', default=0.2, type=float, help='minimum cosine similarity for a reliable cross-modal positive prototype')
    parser.add_argument('--cmpc-start-epoch', default=70, type=int, help='phase2 epoch to start cross-modal prototype contrastive ranking')
    parser.add_argument('--cmpc-end-epoch', default=90, type=int, help='exclusive phase2 epoch to stop cross-modal prototype contrastive ranking')
    parser.add_argument('--cmpc-warmup-epochs', default=10, type=int, help='epochs used to ramp cross-modal prototype contrastive ranking')
