...
def get_parser():
    ...
    parser.add_argument('--enable-structured-feature', default=1, type=int, help='enable structured local part feature fusion in backbone')
    parser.add_argument('--structured-parts', default=3, type=int, help='number of horizontal stripes used by structured feature fusion')
    parser.add_argument('--structured-weight', default=0.2, type=float, help='fusion weight for structured local feature branch')
