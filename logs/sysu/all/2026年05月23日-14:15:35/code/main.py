...
def get_parser():
    ...
    parser.add_argument('--enable-trrm', default=1, type=int, help='enable temporal reliability relation memory')
    ...
    parser.add_argument('--trrm-specific-max-ratio', default=0.5, type=float, help='maximum ratio of reliable specific relations kept each epoch')
    ...
    parser.add_argument('--trrm-specific-ramp', default=10, type=int, help='epochs used to ramp up the specific relation loss weight')
