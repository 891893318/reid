...
def get_parser():
    ...
    parser.add_argument('--cmhn-weight', default=0.0, type=float, help='weight of common-relation cross-modal hard-negative ranking loss')
    parser.add_argument('--cmhn-margin', default=0.2, type=float, help='cosine similarity margin for common hard-negative ranking')
    parser.add_argument('--cmhn-start-epoch', default=10, type=int, help='first phase2 epoch using common hard-negative ranking')
    parser.add_argument('--cmhn-end-epoch', default=70, type=int, help='exclusive phase2 epoch ending common hard-negative ranking')
    parser.add_argument('--cmhn-topk', default=1, type=int, help='number of hardest common prototypes averaged as negatives')
    parser.add_argument('--cmhn-require-positive-top1', default=1, type=int, help='only expand the margin when the common positive prototype already ranks first')
