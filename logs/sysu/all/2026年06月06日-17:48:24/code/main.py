...
def get_parser():
    ...
    parser.add_argument('--enable-graymix-audit', default=0, type=int, help='use GrayMix agreement to audit ambiguous remain relations')
    parser.add_argument('--graymix-lambda', default=0.5, type=float, help='fixed GrayMix strength used for stable relation auditing')
    parser.add_argument('--graymix-audit-start-epoch', default=0, type=int, help='phase2 epoch to start GrayMix remain-relation auditing')
