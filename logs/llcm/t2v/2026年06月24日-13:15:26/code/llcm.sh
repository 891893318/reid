...
COMMON_ARGS=(
    ...
    --uprt-recovery-min-entropy 0.10
    --uprt-recovery-temperature 0.20
    --uprt-recovery-topk 40
    --uprt-start-epoch 5
...
do
    echo "====================================="
    echo " Running LLCM ${mode}"
    echo "====================================="
    python3 main.py "${COMMON_ARGS[@]}" --test-mode "$mode"
done
