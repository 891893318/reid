...
def get_parser():
    ...
    parser.add_argument('--bcpt-pred-weight', default=0.45, type=float, help='BCPT prediction consistency weight')
    parser.add_argument('--bcpt-feat-weight', default=0.40, type=float, help='BCPT prototype feature weight')
    parser.add_argument('--bcpt-conf-weight', default=0.15, type=float, help='BCPT confidence weight')
    parser.add_argument('--bcpt-ot-reg', default=0.07, type=float, help='BCPT Sinkhorn entropy regularization')
    parser.add_argument('--bcpt-ot-iters', default=30, type=int, help='BCPT Sinkhorn iteration count')
    parser.add_argument('--bcpt-high-th', default=0.55, type=float, help='BCPT high confidence threshold')
    parser.add_argument('--bcpt-mid-th', default=0.25, type=float, help='BCPT medium confidence threshold')
    parser.add_argument('--bcpt-topk', default=3, type=int, help='BCPT top-k support for weak supervision')
