...
def get_parser():
    ...
    parser.add_argument('--fimro-alpha', default=0.1, type=float, dest='fimro_alpha', help='weight of low-frequency consistency loss')
    parser.add_argument('--fimro-beta', default=0.1, type=float, dest='fimro_beta', help='weight of high-frequency auxiliary ID loss')
    ...
    parser.add_argument('--fimro-fuse-scale', default=0.2, type=float, dest='fimro_fuse_scale', help='residual fusion scale for high-frequency features')
    ...
    parser.add_argument('--soft-cm-weight', default=0.2, type=float, dest='soft_cm_weight', help='weight of soft cross-modal classification loss')
