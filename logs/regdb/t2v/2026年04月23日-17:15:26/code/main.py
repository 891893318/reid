...
def get_parser():
    ...
    parser.add_argument('--bmpr-high-th', default=0.78, type=float, help='BMPR high reliability threshold')
    parser.add_argument('--bmpr-mid-th', default=0.60, type=float, help='BMPR medium reliability threshold')
    parser.add_argument('--bmpr-margin-weight', default=0.35, type=float, help='BMPR bidirectional margin weight')
    parser.add_argument('--bmpr-proto-weight', default=0.65, type=float, help='BMPR prototype consistency weight')
    parser.add_argument('--bmpr-topk', default=3, type=int, help='BMPR top-k support for weak supervision')
    parser.add_argument('--bcpt-topk', default=3, type=int, help='Deprecated alias kept for verification scripts')
    parser.add_argument('--match-ema', default=0.8, type=float, help='EMA factor for temporal class-level routing scores')
    parser.add_argument('--match-high-conf', default=0.55, type=float, help='High-confidence threshold for common routing')
    parser.add_argument('--match-low-conf', default=0.35, type=float, help='Low-confidence threshold for specific routing')
    parser.add_argument('--match-stable-epochs', default=2, type=int, help='Required consecutive epochs before a route becomes supervised')
    parser.add_argument('--specific-warmup', default=12, type=int, help='Warmup epochs for specific-route supervision in phase2')
    parser.add_argument('--remain-start', default=30, type=int, help='Start epoch for remain-route weak supervision in phase2')
    parser.add_argument('--remain-warmup', default=10, type=int, help='Warmup epochs for remain-route weak supervision in phase2')
