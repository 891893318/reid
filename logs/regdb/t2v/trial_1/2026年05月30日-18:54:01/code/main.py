...
def get_parser():
    ...
    parser.add_argument('--enable-uotcrt', default=0, type=int, help='enable uncertainty-aware OT cross-modal relation transformer')
    parser.add_argument('--uotcrt-hidden-dim', default=512, type=int, help='hidden dimension of UOT-CRT relation projections')
    parser.add_argument('--uotcrt-temp', default=0.07, type=float, help='temperature for UOT-CRT transport logits')
    parser.add_argument('--uotcrt-iters', default=30, type=int, help='Sinkhorn iterations for UOT-CRT')
    parser.add_argument('--uotcrt-start-epoch', default=0, type=int, help='phase2 epoch to start UOT-CRT losses')
    parser.add_argument('--uotcrt-cm-weight', default=0.1, type=float, help='weight of UOT-CRT soft cross-modal classification')
    parser.add_argument('--uotcrt-proto-weight', default=0.05, type=float, help='weight of UOT-CRT relation-refined prototype alignment')
    parser.add_argument('--uotcrt-cycle-weight', default=0.01, type=float, help='weight of UOT-CRT bidirectional cycle consistency')
    parser.add_argument('--uotcrt-conf-power', default=1.0, type=float, help='confidence exponent for UOT-CRT soft supervision')
    parser.add_argument('--uotcrt-residual-scale', default=0.2, type=float, help='residual scale of UOT-CRT relation-refined prototypes')
