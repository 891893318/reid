    ...
    for (rgb_imgs, ca_imgs, color_info), (ir_imgs, aug_imgs,ir_info) in zip(rgb_loader, ir_loader):
            ...
            if enable_phase1:
                ...
                if args.enable_soft_relation and soft_relation_pack is not None:
                    ...
                    if valid_rgb_soft.any():
                        soft_rgb_loss = args.soft_cm_weight * model.soft_pid_criterion(
                    ...
                    if valid_ir_soft.any():
                        soft_ir_loss = args.soft_cm_weight * model.soft_pid_criterion(
        ...
        if enable_phase1:
            ...
            if args.debug == 'wsl':
                ...
                if (selected_rgb_ids.shape[0]>0) and not args.enable_soft_relation:
                ...
                if not args.enable_soft_relation:
