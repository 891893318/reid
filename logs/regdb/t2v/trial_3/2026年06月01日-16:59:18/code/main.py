...
def get_parser():
    ...
    parser.add_argument('--enable-p2r', default=0, type=int, help='enable prototype-to-relation probabilistic relation reasoning')
    parser.add_argument('--p2r-hidden-dim', default=512, type=int, help='hidden dimension of P2RNet prototype relation encoder')
    parser.add_argument('--p2r-temp', default=0.07, type=float, help='temperature of P2RNet relation logits')
    parser.add_argument('--p2r-iters', default=20, type=int, help='Sinkhorn iterations in P2RNet')
    parser.add_argument('--p2r-start-epoch', default=60, type=int, help='phase2 epoch to start P2RNet relation learning')
    parser.add_argument('--p2r-refine-start-epoch', default=70, type=int, help='phase2 epoch to start relation-conditioned feature refinement')
    parser.add_argument('--p2r-anchor-weight', default=0.01, type=float, help='weight for P2RNet high-confidence anchor loss')
    parser.add_argument('--p2r-soft-weight', default=0.003, type=float, help='weight for P2RNet soft relation supervision')
    parser.add_argument('--p2r-refine-weight', default=0.005, type=float, help='weight for P2RNet relation-conditioned prototype refinement')
    parser.add_argument('--p2r-unc-weight', default=0.001, type=float, help='weight for P2RNet uncertainty regularization')
    parser.add_argument('--p2r-anchor-threshold', default=0.85, type=float, help='minimum confidence for common pairs used as P2RNet anchors')
    parser.add_argument('--p2r-min-anchors', default=32, type=int, help='fallback minimum number of common anchors for P2RNet')
    parser.add_argument('--p2r-candidate-topk', default=5, type=int, help='prototype-neighbor candidates kept per identity in P2RNet')
    parser.add_argument('--p2r-anchor-bias', default=4.0, type=float, help='logit bias for high-confidence P2RNet anchors')
    parser.add_argument('--p2r-candidate-bias', default=1.0, type=float, help='logit bias for P2RNet candidate edges')
    parser.add_argument('--p2r-mask-penalty', default=8.0, type=float, help='logit penalty for non-candidate P2RNet edges')
    parser.add_argument('--p2r-dustbin-logit', default=0.0, type=float, help='dustbin logit for partial matching in P2RNet')
    parser.add_argument('--p2r-use-soft-specific', default=1, type=int, help='replace specific hard labels with P2RNet soft relation labels')
    parser.add_argument('--p2r-use-soft-remain', default=1, type=int, help='replace remain hard weak labels with P2RNet soft relation labels')
    parser.add_argument('--enable-crccl', default=0, type=int, help='enable relation-calibrated collaborative consistency learning')
    parser.add_argument('--crccl-start-epoch', default=20, type=int, help='phase2 epoch to start CRCCL')
    parser.add_argument('--crccl-temp', default=3.0, type=float, help='temperature for CRCCL bidirectional KL')
    parser.add_argument('--crccl-cm-weight', default=0.03, type=float, help='weight of CRCCL calibrated logit consistency')
    parser.add_argument('--crccl-shared-weight', default=0.02, type=float, help='weight of CRCCL shared feature consistency')
    parser.add_argument('--crccl-cf-weight', default=0.003, type=float, help='weight of CRCCL counterfactual modality intervention')
    parser.add_argument('--crccl-cf-scale', default=0.1, type=float, help='scale for shuffled modality-specific counterfactual feature')
    parser.add_argument('--crccl-min-weight', default=0.2, type=float, help='minimum relation weight for CRCCL common pairs')
    parser.add_argument('--crccl-proto-weight', default=0.4, type=float, help='prototype similarity contribution in CRCCL relation calibration')
    parser.add_argument('--crccl-margin-weight', default=0.3, type=float, help='prediction margin contribution in CRCCL relation calibration')
    parser.add_argument('--crccl-certainty-weight', default=0.2, type=float, help='prediction certainty contribution in CRCCL relation calibration')
    parser.add_argument('--crccl-stability-weight', default=0.1, type=float, help='temporal stability contribution in CRCCL relation calibration')
    parser.add_argument('--crccl-replace-cmo', default=0, type=int, help='replace original CMO MSE with CRCCL instead of adding it')
