...
def get_parser():
    ...
    parser.add_argument('--enable-molora', default=0, type=int, dest='enable_molora', help='enable MoLoRA branch')
    parser.add_argument('--molora-phase1', default=0, type=int, dest='molora_phase1', help='enable MoLoRA in phase1 warmup')
    parser.add_argument('--molora-rank', default=64, type=int, dest='molora_rank', help='rank of MoLoRA adapter')
    parser.add_argument('--molora-scale', default=0.05, type=float, dest='molora_scale', help='residual scale for MoLoRA output')
    parser.add_argument('--molora-align-weight', default=0.1, type=float, dest='molora_align_weight', help='weight for MoLoRA alignment loss')
    parser.add_argument('--molora-phase1-lr-scale', default=0.1, type=float, dest='molora_phase1_lr_scale', help='phase1 learning-rate scale for MoLoRA params')
    parser.add_argument('--molora-grad-clip', default=5.0, type=float, dest='molora_grad_clip', help='gradient clipping max-norm for MoLoRA params')
